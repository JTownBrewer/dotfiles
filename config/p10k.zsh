# Generated by Powerlevel10k configuration wizard on 2025-05-23 at 21:26 EDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 49619.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, round separators, round heads, flat tails, 2 lines, disconnected,
# full frame, darkest-ornaments, compact, many icons, concise, transient_prompt,
# instant_prompt=off.
